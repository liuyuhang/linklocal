...
func Update(client *gophercloud.ServiceClient,id string,metadata map[string]interface{}) (r UpdateResult){
	_, r.Err = client.Put(updateMetaURL(client, id), metadata, &r.Body, &gophercloud.RequestOpts{
		OkCodes: []int{200},
	})
	return
}
